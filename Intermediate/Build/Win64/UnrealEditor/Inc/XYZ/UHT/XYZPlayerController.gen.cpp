...
void FSelectionBoxReleasedEvent_DelegateWrapper(const FMulticastScriptDelegate& SelectionBoxReleasedEvent, float x, float y)
{
	...
	struct Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics
	{
		struct _Script_XYZ_eventSelectionIdsEvent_Parms
		{
			TArray<int32> SelectionActorIds;
		};
		static const UECodeGen_Private::FIntPropertyParams NewProp_SelectionActorIds_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_SelectionActorIds_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_SelectionActorIds;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds_Inner = { "SelectionActorIds", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds = { "SelectionActorIds", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_XYZ_eventSelectionIdsEvent_Parms, SelectionActorIds), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::NewProp_SelectionActorIds,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_XYZ, nullptr, "SelectionIdsEvent__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::_Script_XYZ_eventSelectionIdsEvent_Parms), Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FSelectionIdsEvent_DelegateWrapper(const FMulticastScriptDelegate& SelectionIdsEvent, TArray<int32> const& SelectionActorIds)
{
	struct _Script_XYZ_eventSelectionIdsEvent_Parms
	{
		TArray<int32> SelectionActorIds;
	};
	_Script_XYZ_eventSelectionIdsEvent_Parms Parms;
	Parms.SelectionActorIds=SelectionActorIds;
	SelectionIdsEvent.ProcessMulticastDelegate<UObject>(&Parms);
}
	DEFINE_FUNCTION(AXYZPlayerController::execXYZActorDestroyed)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_ActorUId);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->XYZActorDestroyed_Implementation(Z_Param_ActorUId);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(AXYZPlayerController::execSelectActorFromPanel)
	{
		P_GET_PROPERTY(FIntProperty,Z_Param_UActorId);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->SelectActorFromPanel(Z_Param_UActorId);
		P_NATIVE_END;
	}
	...
	struct XYZPlayerController_eventXYZActorDestroyed_Parms
	{
		int32 ActorUId;
	};
	...
	static FName NAME_AXYZPlayerController_XYZActorDestroyed = FName(TEXT("XYZActorDestroyed"));
	void AXYZPlayerController::XYZActorDestroyed(int32 ActorUId)
	{
		XYZPlayerController_eventXYZActorDestroyed_Parms Parms;
		Parms.ActorUId=ActorUId;
		ProcessEvent(FindFunctionChecked(NAME_AXYZPlayerController_XYZActorDestroyed),&Parms);
	}
	void AXYZPlayerController::StaticRegisterNativesAXYZPlayerController()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "SelectActorFromPanel", &AXYZPlayerController::execSelectActorFromPanel },
			{ "SelectActors", &AXYZPlayerController::execSelectActors },
			{ "XYZActorDestroyed", &AXYZPlayerController::execXYZActorDestroyed },
		};
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_AXYZPlayerController_OnInputReleased_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(XYZPlayerController_eventOnInputReleased_Parms, InputType), Z_Construct_UEnum_XYZ_EXYZInputType, METADATA_PARAMS(nullptr, 0) }; // 3594544840
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_AXYZPlayerController_OnInputStarted_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(XYZPlayerController_eventOnInputStarted_Parms, InputType), Z_Construct_UEnum_XYZ_EXYZInputType, METADATA_PARAMS(nullptr, 0) }; // 3594544840
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_AXYZPlayerController_OnInputTriggered_Statics::NewProp_InputType = { "InputType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(XYZPlayerController_eventOnInputTriggered_Parms, InputType), Z_Construct_UEnum_XYZ_EXYZInputType, METADATA_PARAMS(nullptr, 0) }; // 3594544840
	...
	struct Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics
	{
		struct XYZPlayerController_eventSelectActorFromPanel_Parms
		{
			int32 UActorId;
		};
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::NewProp_UActorId = { "UActorId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(XYZPlayerController_eventSelectActorFromPanel_Parms, UActorId), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::NewProp_UActorId,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::Function_MetaDataParams[] = {
		{ "Category", "UI" },
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AXYZPlayerController, nullptr, "SelectActorFromPanel", nullptr, nullptr, sizeof(Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::XYZPlayerController_eventSelectActorFromPanel_Parms), Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04080401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics
	{
		static const UECodeGen_Private::FIntPropertyParams NewProp_ActorUId;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::NewProp_ActorUId = { "ActorUId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(XYZPlayerController_eventXYZActorDestroyed_Parms, ActorUId), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::NewProp_ActorUId,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AXYZPlayerController, nullptr, "XYZActorDestroyed", nullptr, nullptr, sizeof(XYZPlayerController_eventXYZActorDestroyed_Parms), Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00024CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MoveCursor_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_MoveCursor;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_AttackCursor_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_AttackCursor;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ClearSelectionInputAction_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_ClearSelectionInputAction;
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnSelectionIdsEvent_MetaData[];
#endif
		static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnSelectionIdsEvent;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bAllowMouseInput_MetaData[];
#endif
		static void NewProp_bAllowMouseInput_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bAllowMouseInput;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AXYZPlayerController_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AXYZPlayerController_OnInputReleased, "OnInputReleased" }, // 2504771508
		{ &Z_Construct_UFunction_AXYZPlayerController_OnInputStarted, "OnInputStarted" }, // 3302698196
		{ &Z_Construct_UFunction_AXYZPlayerController_OnInputTriggered, "OnInputTriggered" }, // 3396188018
		{ &Z_Construct_UFunction_AXYZPlayerController_QueueInput, "QueueInput" }, // 4137085768
		{ &Z_Construct_UFunction_AXYZPlayerController_SelectActorFromPanel, "SelectActorFromPanel" }, // 3423428879
		{ &Z_Construct_UFunction_AXYZPlayerController_SelectActors, "SelectActors" }, // 1853716492
		{ &Z_Construct_UFunction_AXYZPlayerController_XYZActorDestroyed, "XYZActorDestroyed" }, // 983384884
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_MoveCursor_MetaData[] = {
		{ "Category", "Input" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_MoveCursor = { "MoveCursor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AXYZPlayerController, MoveCursor), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_MoveCursor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_MoveCursor_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_AttackCursor_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_AttackCursor = { "AttackCursor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AXYZPlayerController, AttackCursor), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_AttackCursor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_AttackCursor_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_ClearSelectionInputAction_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Input" },
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_ClearSelectionInputAction = { "ClearSelectionInputAction", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AXYZPlayerController, ClearSelectionInputAction), Z_Construct_UClass_UInputAction_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_ClearSelectionInputAction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_ClearSelectionInputAction_MetaData)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_OnSelectionIdsEvent_MetaData[] = {
		{ "Category", "Events" },
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_OnSelectionIdsEvent = { "OnSelectionIdsEvent", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AXYZPlayerController, OnSelectionIdsEvent), Z_Construct_UDelegateFunction_XYZ_SelectionIdsEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_OnSelectionIdsEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_OnSelectionIdsEvent_MetaData)) }; // 2744961354
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput_MetaData[] = {
		{ "Category", "Input" },
		{ "ModuleRelativePath", "XYZPlayerController.h" },
	};
#endif
	void Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput_SetBit(void* Obj)
	{
		((AXYZPlayerController*)Obj)->bAllowMouseInput = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput = { "bAllowMouseInput", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(AXYZPlayerController), &Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput_SetBit, METADATA_PARAMS(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_InputTriggeredTime_Key_KeyProp = { "InputTriggeredTime_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UEnum_XYZ_EXYZInputType, METADATA_PARAMS(nullptr, 0) }; // 3594544840
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AXYZPlayerController_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_MoveCursor,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_AttackCursor,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_ClearSelectionInputAction,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_OnSelectionIdsEvent,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AXYZPlayerController_Statics::NewProp_bAllowMouseInput,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OneDrive_Documents_Unreal_Projects_XYZ_Source_XYZ_XYZPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AXYZPlayerController, AXYZPlayerController::StaticClass, TEXT("AXYZPlayerController"), &Z_Registration_Info_UClass_AXYZPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AXYZPlayerController), 1228649682U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OneDrive_Documents_Unreal_Projects_XYZ_Source_XYZ_XYZPlayerController_h_1476613127(TEXT("/Script/XYZ"),
