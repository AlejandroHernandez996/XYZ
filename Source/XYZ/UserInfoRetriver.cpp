...
void UUserInfoRetriver::GetAllUserNetIdsToDisplayNames(TArray<TSharedRef<const FUniqueNetId>> UniqueNetIds) {
    ...
    this->QueryUserInfoDelegateHandle = User->AddOnQueryUserInfoCompleteDelegate_Handle(
        ...
        FOnQueryUserInfoComplete::FDelegate::CreateUObject(
            this,
            &UUserInfoRetriver::HandleQueryUserInfoComplete));

    User->QueryUserInfo(0 /* LocalUserNum */, UniqueNetIds);
}

void UUserInfoRetriver::SetUserNetIdsToDisplayName(APlayerController* InPlayerController) {
...
void UUserInfoRetriver::HandleQueryUserInfoComplete(
    int32 LocalUserNum,
    bool bWasSuccessful,
...
TSharedPtr<const FUniqueNetId> UUserInfoRetriver::GetControllerUniqueNetId(APlayerController* InPlayerController)
{
